...
OUTPUT_SCHEMA = {
    ...
    "properties": {
        ...
        "sintesis": {
            ...
            "properties": {
                "estado": {"type": "string",
                           "description": "hasta 2 oraciones, salud contra el target "
                                          "ACoS anclada en cifras del documento KPIs"},
                "movimientos": {"type": "array", "items": {"type": "string"},
                                "description": "2 a 4 bullets, cada uno con una cifra "
                                               "ya existente en los documentos"},
                "riesgo": {"type": "string",
                           "description": "1 oración, una sola exposición dominante"},
            },
            "required": ["estado", "movimientos", "riesgo"],
            "additionalProperties": False,
        },
    },
    "required": ["negativos", "harvest", "campanas", "sintesis"],
    "additionalProperties": False,
}
