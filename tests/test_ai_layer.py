"""core/ai_layer - reusable AI-analysis integration layer.
...
labels = ai_layer.ai_labels("es", {{"chat": "smoke chat"}})
analysis = ai_layer.resolve_analysis(
...
if analysis is not None:
    ai_layer.render_analysis(analysis, slug="{_FAKE_SLUG}", labels=labels,
                             render_result=_render)
ai_layer.mount_analysis_chat("{_FAKE_SLUG}", analysis, lang="es",
                             labels=labels)
"""
