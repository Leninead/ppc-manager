...
4. **Account Pulse (M21)** — monitor de salud diaria con deltas y festivos MX
...
- 🎯 **Para qué sirve:** Dashboard del Agency OS con estado de 22 módulos, Workflow Wizard piramidal y changelog.
...
- 🎯 **Para qué sirve:** Analizar search terms de campañas SP para negativizar, harvestear y clasificar por estado.
...
- 🎯 **Para qué sirve:** Medir market share, detectar gaps y oportunidades orgánicas contra el mercado de Brand Analytics.
...
- 🎯 **Para qué sirve:** Cruzar lo que pasa en tus campañas (STR) contra lo que pasa en el mercado (SQP) y generar un Plan de Acción accionable.
...
- 🎯 **Para qué sirve:** Ver estructura de campañas y diagnosticar estado con semáforo automático (pausar/revisar/escalar/fantasmas).
...
- 🎯 **Para qué sirve:** Calcular el bid óptimo por keyword usando CVR real, precio y target ACoS. Fórmula: `bid = CVR × precio × target_ACoS`.
...
- 🎯 **Para qué sirve:** Generar bulk listo para subir a Amazon con campañas SP nuevas clusterizadas por intención.
...
- 🎯 **Para qué sirve:** Generar reporte semanal para el cliente con comparación WoW automática + changelog técnico.
...
- ▶️ **Pasos:**
  ...
  5. Descargá Excel 3 hojas + botón "Copiar Changelog para Slack"
- 📤 **Output:** Excel (WoW + Advertising + Ejecutivo + Changelog) + texto Slack copiable.
- ➡️ **Siguiente paso:** Account Pulse (M21) para monitor de salud continuo.
...
- 🎯 **Para qué sirve:** Procesar reportes DataDive: MKL keywords, competitors matrix, rank radar y volatilidad de ranking.
...
- ➡️ **Siguiente paso:** Helium 10 Analyzer (M16) para cross-validation.

---

## M16 — 🧲 Helium 10 Analyzer

- 🎯 **Para qué sirve:** Procesar Cerebro (reverse ASIN) para KW research, competitor gap y oportunidades PPC.
...
- ➡️ **Siguiente paso:** SBH Recommendation (M17) o Campaign Builder (M10).
...
### SECCIÓN: 👁️ Listing Monitor + Knowledge
