...
- **OPTIPET FlavorBoost** (cliente personal Lenin, NO Capybaras): esperando respuesta Mario (PETSA) sobre asignación final de 2 UPCs (de pool ADAM REQUEST de 4 UPCs nuevos en master sheet INASA rows 21-24) + estado de cajas físicas. Mensaje enviado 2026-05-14 al chat INASA. Cuando Mario confirme, se arma v5 flat file (con peso 297g corregido vs 360g v4) y se sube a Amazon. Hígado en track separado (compliance docs cliente pendiente). Decisión epistemológica adoptada: no asumir nada no dicho explícitamente. Seguimiento en [[daily/2026-05-14]] · [[optipet]] · [[arranque-optipet]].
