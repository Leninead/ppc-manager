...
""",
    ...
    "request_log.kind.sp_campaigns": "Métricas de campañas",
    "request_log.kind.campaign_entities": "Campañas",
    "request_log.kind.sp_targets": "Keywords y targets SP",
    "request_log.kind.sp_product_ads": "Productos anunciados SP",
    "request_log.kind.sp_ad_groups": "Ad groups SP",
    "request_log.kind.sp_negatives": "Negativos SP",
    "request_log.kind.sb_entities": "Campañas y targets SB",
    "request_log.kind.sd_entities": "Campañas y targets SD",
    "request_log.kind.sp_targeting": "Métricas de targeting SP",
    "request_log.kind.sb_campaigns": "Métricas de campañas SB",
    "request_log.kind.sb_targeting": "Métricas de targeting SB",
    "request_log.kind.sb_legacy_campaigns": "Métricas de campañas SB del formato anterior",
    "request_log.kind.sd_campaigns": "Métricas de campañas SD",
    "request_log.kind.sd_targeting": "Métricas de targeting SD",
    "request_log.kind.ai_str_analysis": "Análisis IA de search terms",
    "request_log.kind.ai_bulk_campaigns_analysis": "Análisis IA de campañas",
    "request_log.kind.ai_ppc_insights_analysis": "Análisis IA de PPC Insights",
    ...
    "request_log.sub.campaigns_one": "1 campaña",
    "request_log.sub.campaigns_other": "{n} campañas",
    "request_log.sub.targets_one": "1 keyword o target",
    "request_log.sub.targets_other": "{n} keywords y targets",
    "request_log.sub.product_ads_one": "1 producto anunciado",
    "request_log.sub.product_ads_other": "{n} productos anunciados",
    "request_log.sub.ad_groups_one": "1 ad group",
    "request_log.sub.ad_groups_other": "{n} ad groups",
    "request_log.sub.negatives_one": "1 negativo",
    "request_log.sub.negatives_other": "{n} negativos",
    ...
    # ── Inicio (home) ───────────────────────────────────────────────────
    "home.date": "{weekday} {day} de {month}",
    "home.weekdays": "Lunes,Martes,Miércoles,Jueves,Viernes,Sábado,Domingo",
    "home.months": (
        "enero,febrero,marzo,abril,mayo,junio,julio,agosto,septiembre,octubre,noviembre,diciembre"
    ),
    "home.title": "Bienvenidos a Agency OS",
    "home.subtitle": "El sistema operativo del equipo de Capybaras Agency.",
    "home.kpi.modules_one": "módulo activo",
    "home.kpi.modules_other": "módulos activos",
    "home.kpi.areas_one": "área",
    "home.kpi.areas_other": "áreas",
    "home.news.title": "Novedades",
    "home.news.this_week_one": "{n} esta semana",
    "home.news.this_week_other": "{n} esta semana",
    "home.news.date": "{day} {month}",
    "home.news.meta": "{date} · {kind}",
    "home.news.open": "Abrir",
    "home.news.open_arrow": "Abrir →",
    "home.kind.new": "Nuevo",
    "home.kind.improvement": "Mejora",
    "home.resources.title": "Recursos del equipo",
    "home.resources.docs_one": "{n} documento",
    "home.resources.docs_other": "{n} documentos",
    "home.resources.sops_ppc_body": "SOPs, prompts y skills del equipo PPC.",
    "home.resources.sops_am_body": "SOPs del equipo de Account Managers.",
    "home.resources.kb_body": "Notas, aprendizajes e ideas del equipo.",
    "home.resources.open": "Abrir",
    "home.areas.title": "Nuestras áreas",
    "home.areas.summary": "{areas} · {modules}",
    "home.areas.owner": "Responsable: {owner}",
    "home.count.areas_one": "{n} área",
...
""",
    ...
    "request_log.kind.sp_campaigns": "Campaign metrics",
    "request_log.kind.campaign_entities": "Campaigns",
    "request_log.kind.sp_targets": "SP keywords and targets",
    "request_log.kind.sp_product_ads": "SP advertised products",
    "request_log.kind.sp_ad_groups": "SP ad groups",
    "request_log.kind.sp_negatives": "SP negatives",
    "request_log.kind.sb_entities": "SB campaigns and targets",
    "request_log.kind.sd_entities": "SD campaigns and targets",
    "request_log.kind.sp_targeting": "SP targeting metrics",
    "request_log.kind.sb_campaigns": "SB campaign metrics",
    "request_log.kind.sb_targeting": "SB targeting metrics",
    "request_log.kind.sb_legacy_campaigns": "Old-format SB campaign metrics",
    "request_log.kind.sd_campaigns": "SD campaign metrics",
    "request_log.kind.sd_targeting": "SD targeting metrics",
    "request_log.kind.ai_str_analysis": "Search terms AI analysis",
    "request_log.kind.ai_bulk_campaigns_analysis": "Campaigns AI analysis",
    "request_log.kind.ai_ppc_insights_analysis": "PPC Insights AI analysis",
    ...
    "request_log.sub.portfolios_one": "1 portfolio",
    "request_log.sub.portfolios_other": "{n} portfolios",
    "request_log.sub.campaigns_one": "1 campaign",
    "request_log.sub.campaigns_other": "{n} campaigns",
    "request_log.sub.targets_one": "1 keyword or target",
    "request_log.sub.targets_other": "{n} keywords and targets",
    "request_log.sub.product_ads_one": "1 advertised product",
    "request_log.sub.product_ads_other": "{n} advertised products",
    "request_log.sub.ad_groups_one": "1 ad group",
    "request_log.sub.ad_groups_other": "{n} ad groups",
    "request_log.sub.negatives_one": "1 negative",
    "request_log.sub.negatives_other": "{n} negatives",
    ...
    "home.weekdays": "Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday",
    "home.months": (
        "January,February,March,April,May,June,July,August,September,October,November,December"
    ),
    "home.title": "Welcome to Agency OS",
    "home.subtitle": "The operating system of the Capybaras Agency team.",
    "home.kpi.modules_one": "active module",
    "home.kpi.modules_other": "active modules",
    "home.kpi.areas_one": "area",
    "home.kpi.areas_other": "areas",
    "home.news.title": "What's new",
    "home.news.this_week_one": "{n} this week",
    "home.news.this_week_other": "{n} this week",
    "home.news.date": "{month} {day}",
    "home.news.meta": "{date} · {kind}",
    "home.news.open": "Open",
    "home.news.open_arrow": "Open →",
    "home.kind.new": "New",
    "home.kind.improvement": "Improvement",
    "home.resources.title": "Team resources",
    "home.resources.docs_one": "{n} document",
    "home.resources.docs_other": "{n} documents",
    "home.resources.sops_ppc_body": "SOPs, prompts and skills of the PPC team.",
    "home.resources.sops_am_body": "SOPs of the Account Managers team.",
    "home.resources.kb_body": "Team notes, learnings and ideas.",
    "home.resources.open": "Open",
    "home.areas.title": "Our areas",
    "home.areas.summary": "{areas} · {modules}",
    "home.areas.owner": "Owner: {owner}",
    "home.count.areas_one": "{n} area",
