...
def _build_weekly_excel(br_tw, br_pw, atom_tw, atom_pw, client_name="", lang="es", br_daily=None, camp_data=None, changelog_text="",
    ...
    # Cualquier otra cosa (lo unico que existe hoy: un solo by-Child de 14d) es
    # MODO PERIODO COMPLETO, y se rotula como tal. Se mira `days`, no la mera
    # presencia del dato: un periodo informado de 14d NO habilita el WoW.
    modo_wow = bool(
